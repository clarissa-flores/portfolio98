...
(function oneko() {
  ...
  function init() {
    ...
    if (!storedNeko) {
      ...
      const taskbarRect = taskbar ? taskbar.getBoundingClientRect() : { left: 0, top: window.innerHeight - 40, right: window.innerWidth, height: 40 };
      const clockRect = clock ? clock.getBoundingClientRect() : null;
      const baseX = clockRect ? clockRect.left - 24 : taskbarRect.right - 48;
      const baseY = taskbarRect.top - 32;
      nekoPosX = baseX + 16;
      nekoPosY = baseY + 16;
    }
